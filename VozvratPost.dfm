object frmVozvratPost: TfrmVozvratPost
  Left = 131
  Top = 99
  BorderStyle = bsDialog
  Caption = #1042#1086#1079#1074#1088#1072#1090#1085#1099#1077' '#1085#1072#1082#1083#1072#1076#1085#1099#1077' '#1087#1086#1089#1090#1072#1074#1097#1080#1082#1072#1084
  ClientHeight = 406
  ClientWidth = 598
  Color = clBtnFace
  ...
  object ActionList1: TActionList
    ...
    object actShowParentNaklp: TAction
      Caption = #1055#1086#1082#1072#1079#1072#1090#1100' '#1088#1086#1076#1080#1090#1077#1083#1100#1089#1082#1091#1102' '#1087#1088#1080#1093#1086#1076#1085#1091#1102
      OnExecute = actShowParentNaklpExecute
    end
    ...
    object actShowNaklo: TAction
      Caption = #1055#1086#1082#1072#1079#1072#1090#1100' '#1079#1072#1074#1080#1089#1080#1084#1099#1077' '#1089#1082#1083#1072#1076#1089#1082#1080#1077' '#1086#1090#1075#1088#1091#1079#1082#1080
      OnExecute = actShowNakloExecute
    end
    object actShowRepNalDolg: TAction
      Caption = #1054#1090#1095#1105#1090' '#1087#1086' '#1085#1072#1083#1080#1095#1085#1099#1084' '#1076#1086#1083#1075#1072#1084
      OnExecute = actShowRepNalDolgExecute
    end
  ...
  object sdsNaklo: TSQLDataSet
    CommandText = 
      ...
      'nt_id'#13#10'   '#13#10'from '#13#10'  VOZVRAT_POST_VW om'#13#10'order by'#13#10'  om.dat, om.' +
      'id_nakl'#13#10
    MaxBlobSize = -1
    Params = <>
  ...
  object sdsPost: TSQLDataSet
    CommandText = 'VOZVRAT_POST_POST_PC'
  ...
  object sdsUnpost: TSQLDataSet
    CommandText = 'VOZVRAT_POST_UNPOST_PC'
    CommandType = ctStoredProc
    MaxBlobSize = -1
    Params = <
      item
  ...
  object MainMenu1: TMainMenu
    ...
    object N1: TMenuItem
      ...
      object N3: TMenuItem
        Action = actShowParentNaklp
      end
      object N10: TMenuItem
        Action = actShowRepNalDolg
      end
    end
  end
  ...
  object sdsDelmark: TSQLDataSet
    CommandText = 'VOZVRAT_POST_DELMARK_PC'
    CommandType = ctStoredProc
    MaxBlobSize = -1
    Params = <
      item
  ...
  object sdsNaklot: TSQLDataSet
    CommandText = 
      ...
      'd.id_tovar,'#13#10'  d.kodcn,'#13#10'  d.kolotp,'#13#10'  d.skidka'#13#10'from VOZVRAT_P' +
      'OST_DET_VW d '#13#10'where  d.id_nakl=:id_nakl'#13#10'order by d.id_pos'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftUnknown
  ...
  object PopupMenu2: TPopupMenu
    ...
    object N5: TMenuItem
      Action = actAddDet
      Caption = #1044#1086#1073#1072#1074#1080#1090#1100' '#1087#1086#1079#1080#1094#1080#1080' '#1080#1079' '#1087#1088#1080#1093#1086#1076#1085#1086#1081
    end
  end
