object frmVidDostavkiSpr: TfrmVidDostavkiSpr
  Left = 94
  Top = 170
  BorderStyle = bsDialog
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' '#1074#1080#1076#1086#1074' '#1076#1086#1089#1090#1072#1074#1082#1080
  ClientHeight = 237
  ClientWidth = 631
  Color = clBtnFace
  ...
  object sdsSklad: TSQLDataSet
    CommandText = 'select *'#13#10'from SPR_VID_DOSTAVKI_VW'#13#10'order by name'
    MaxBlobSize = -1
    Params = <>
