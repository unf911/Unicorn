...
var
  frmStatyaEdit: TfrmStatyaEdit;

implementation
  uses AtsAssert,untRound;
{$R *.dfm}

procedure TfrmStatyaEdit.actOkExecute(Sender: TObject);
begin
  ModalResult := mrOk;
end;

procedure TfrmStatyaEdit.actCancelExecute(Sender: TObject);
begin
  ModalResult := mrCancel;
end;

procedure TfrmStatyaEdit.FormClose(Sender: TObject;
