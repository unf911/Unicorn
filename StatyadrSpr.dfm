object frmStatyadrSpr: TfrmStatyadrSpr
  Left = 366
  Top = 347
  BorderStyle = bsDialog
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' '#1089#1090#1072#1090#1077#1081' '#1076#1086#1093#1086#1076#1086#1074' '#1080' '#1088#1072#1089#1093#1086#1076#1086#1074
  ClientHeight = 218
  ClientWidth = 631
  Color = clBtnFace
  ...
  object sdsSklad: TSQLDataSet
    CommandText = 'select *'#13#10'from SPR_STATYADR_VW'#13#10'order by name'
    MaxBlobSize = -1
    Params = <>
