...
var
  iSchetTip : integer;
begin
  iSchetTip := dmdEx.GetOidObjects('��� �����',-100);
  iSchet := dmdEx.GetOidObjects('������������� ���',iSchetTip);
  iSchetTara := dmdEx.GetOidObjects('������������� ��� ����',iSchetTip);  
...
begin
  ...
  iSkladTreeOid:=dmdEx.GetOidObjects('��� �������� �������',-100);
  iSkladTreeOid:=dmdEx.GetOidObjects('��� �����',iSkladTreeOid);
