...
{                      XML Data Binding                       }
{                                                             }
{         Generated on: 13.02.2012 21:52:54                   }
{       Generated from: D:\data\work\UniSebest\J0215103.xsd   }
{   Settings stored in: D:\data\work\UniSebest\J0215103.xdb   }
{                                                             }
{*************************************************************}
...
{ IXMLDeclarContent }
  ...
  IXMLDeclarContent = interface(IXMLNode)
    ['{B82618BE-9584-459B-977D-BCDFA589854E}']
    { Property Accessors }
...
{ IXMLDHead }
  ...
  IXMLDHead = interface(IXMLNode)
    ['{E5C826DE-44A1-4998-AA7F-7F789079454D}']
    { Property Accessors }
...
{ IXMLLINKED_DOCS }
  ...
  IXMLLINKED_DOCS = interface(IXMLNodeCollection)
    ['{847A4272-82BB-4EB3-A65B-468029C47AB9}']
    { Property Accessors }
...
{ IXMLDOC }
  ...
  IXMLDOC = interface(IXMLNode)
    ['{E831DEE2-3E71-4B17-9516-07832180FF9D}']
    { Property Accessors }
...
{ IXMLDBody }
  ...
  IXMLDBody = interface(IXMLNode)
    ['{28A18104-C69E-4057-98AB-80847E538416}']
    { Property Accessors }
...
{ IXMLIndTaxNumColumn }
  ...
  IXMLIndTaxNumColumn = interface(IXMLNode)
    ['{CD9FE247-E8F3-464E-B4E9-2B6F6CFE2EDD}']
    { Property Accessors }
...
{ IXMLIndTaxNumColumnList }
  ...
  IXMLIndTaxNumColumnList = interface(IXMLNodeCollection)
    ['{6E43B723-B991-4525-B229-D59967461FE2}']
    { Methods & Properties }
...
{ IXMLDecimal2Column }
  ...
  IXMLDecimal2Column = interface(IXMLNode)
    ['{FA80C71A-4BBB-4217-B39A-3F8C181E756B}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDecimal2ColumnList }
  ...
  IXMLDecimal2ColumnList = interface(IXMLNodeCollection)
    ['{09B32BA1-DEAF-49A4-AE0A-74DD3676E6FF}']
    { Methods & Properties }
...
{ IXMLMonthColumn }
  ...
  IXMLMonthColumn = interface(IXMLNode)
    ['{0008B311-AB67-43E7-BC5E-6F1E29606227}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLMonthColumnList }
  ...
  IXMLMonthColumnList = interface(IXMLNodeCollection)
    ['{876FF2D8-39A8-47F2-A8B8-E1125E75CBFF}']
    { Methods & Properties }
...
{ IXMLYearColumn }
  ...
  IXMLYearColumn = interface(IXMLNode)
    ['{4629E4AF-4FB0-4EFF-B06E-B368DA9FA388}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLYearColumnList }
  ...
  IXMLYearColumnList = interface(IXMLNodeCollection)
    ['{76AAE5A1-4B48-4F4A-B642-AA3C0944F241}']
    { Methods & Properties }
