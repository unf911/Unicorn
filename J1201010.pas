...
{                XML Data Binding                 }
{                                                 }
{         Generated on: 03.12.2018 17:36:58       }
{       Generated from: Z:\Unicorn\J1201010.xsd   }
{   Settings stored in: Z:\Unicorn\J1201010.xdb   }
{                                                 }
{*************************************************}
...
{ IXMLDeclarContent }
  ...
  IXMLDeclarContent = interface(IXMLNode)
    ['{49DEF960-936B-44E2-9FA8-14EE7F264EC4}']
    { Property Accessors }
...
{ IXMLDHead }
  ...
  IXMLDHead = interface(IXMLNode)
    ['{41EEBB82-44CB-4C1C-BA98-26DFF2CFDA47}']
    { Property Accessors }
...
{ IXMLLINKED_DOCS }
  ...
  IXMLLINKED_DOCS = interface(IXMLNodeCollection)
    ['{67FDA7FC-DB75-4895-A9E7-871CA1E0B0EB}']
    { Property Accessors }
...
{ IXMLDOC }
  ...
  IXMLDOC = interface(IXMLNode)
    ['{C83D9129-6E66-4779-AA83-8DAD87149D28}']
    { Property Accessors }
...
{ IXMLDBody }
  ...
  IXMLDBody = interface(IXMLNode)
    ['{B968EFF2-B70C-433B-81FC-09AF911A2A93}']
    { Property Accessors }
...
{ IXMLStrColumn }
  ...
  IXMLStrColumn = interface(IXMLNode)
    ['{567185D4-5017-4DA4-8B15-D5BC2EBC0953}']
    { Property Accessors }
...
{ IXMLStrColumnList }
  ...
  IXMLStrColumnList = interface(IXMLNodeCollection)
    ['{E4C33DED-A4B5-413B-96DF-72A17EE5728D}']
    { Methods & Properties }
...
{ IXMLUKTZEDColumn }
  ...
  IXMLUKTZEDColumn = interface(IXMLNode)
    ['{DAA51258-1369-4FF9-A577-D631BC412E55}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLUKTZEDColumnList }
  ...
  IXMLUKTZEDColumnList = interface(IXMLNodeCollection)
    ['{D76C0EFD-B02A-44EF-BF4D-C731351AB972}']
    { Methods & Properties }
...
{ IXMLChkColumn }
  ...
  IXMLChkColumn = interface(IXMLNode)
    ['{B686E95C-A8BD-49A3-826F-9971ADDD6B36}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLChkColumnList }
  ...
  IXMLChkColumnList = interface(IXMLNodeCollection)
    ['{8F93D5F0-224A-4BE7-8589-69F62B8DC7BF}']
    { Methods & Properties }
...
{ IXMLDKPPColumn }
  ...
  IXMLDKPPColumn = interface(IXMLNode)
    ['{EFFF113F-BD4A-4908-8422-06A41DF8DA86}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDKPPColumnList }
  ...
  IXMLDKPPColumnList = interface(IXMLNodeCollection)
    ['{D102A574-64A8-49A0-9C83-CEE256DC6CC6}']
    { Methods & Properties }
...
{ IXMLDGI4lzColumn }
  ...
  IXMLDGI4lzColumn = interface(IXMLNode)
    ['{A7726502-D1AE-40CD-AA56-6F3FE3A12E86}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDGI4lzColumnList }
  ...
  IXMLDGI4lzColumnList = interface(IXMLNodeCollection)
    ['{264EE6EA-E11E-43C7-A816-E26E1AAFF160}']
    { Methods & Properties }
...
{ IXMLDecimal12Column_R }
  ...
  IXMLDecimal12Column_R = interface(IXMLNode)
    ['{798136B6-3E8B-47B3-BEDA-6B4D8DBAE482}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDecimal12Column_RList }
  ...
  IXMLDecimal12Column_RList = interface(IXMLNodeCollection)
    ['{252113BA-8119-4B10-94B2-17A3FDE269BD}']
    { Methods & Properties }
...
{ IXMLDGI3nomColumn }
  ...
  IXMLDGI3nomColumn = interface(IXMLNode)
    ['{E8037630-035B-4086-8596-CE19F38BDEAC}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDGI3nomColumnList }
  ...
  IXMLDGI3nomColumnList = interface(IXMLNodeCollection)
    ['{38E21EB2-025E-4A7B-9DE0-1839A4948F80}']
    { Methods & Properties }
...
{ IXMLCodPilgColumn }
  ...
  IXMLCodPilgColumn = interface(IXMLNode)
    ['{AE71B391-9EC8-4FA5-BD87-51C3E286D12A}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLCodPilgColumnList }
  ...
  IXMLCodPilgColumnList = interface(IXMLNodeCollection)
    ['{A95F32B1-A5B2-4AA1-A671-0C5F790734C0}']
    { Methods & Properties }
...
{ IXMLDecimal2Column_P }
  ...
  IXMLDecimal2Column_P = interface(IXMLNode)
    ['{D2BBD174-C20C-479C-BD98-7C34683B8867}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDecimal2Column_PList }
  ...
  IXMLDecimal2Column_PList = interface(IXMLNodeCollection)
    ['{DDB95D41-E062-4EB4-BEC1-DF0AD1CD362E}']
    { Methods & Properties }
...
{ IXMLDecimal6Column_R }
  ...
  IXMLDecimal6Column_R = interface(IXMLNode)
    ['{C5827F0B-70DC-4781-88A4-E4D5F4A922A2}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDecimal6Column_RList }
  ...
  IXMLDecimal6Column_RList = interface(IXMLNodeCollection)
    ['{A8DA8DDC-6030-4B61-BCE1-8EA0869E52C5}']
    { Methods & Properties }
