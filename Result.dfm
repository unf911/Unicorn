object frmResult: TfrmResult
  ...
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' '#1088#1077#1079#1091#1083#1100#1090#1072#1090#1086#1074' '#1082#1086#1085#1090#1072#1082#1090#1086#1074
  ClientHeight = 237
  ClientWidth = 539
  Color = clBtnFace
  ...
  object sdsSklad: TSQLDataSet
    ...
    CommandText = 
      ...
      #1056#1045#1047#1059#1051#1068#1058#1040#1058#1054#1042' '#1050#1054#1053#1058#1040#1050#1058#1054#1042#39',-100)) '#13#10'order by'#13#10'  o.name,'#13#10'  o.delmark' +
      'ed'#13#10
    Params = <>
    Left = 72
    Top = 56
