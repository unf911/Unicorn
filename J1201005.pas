...
{                            XML Data Binding                             }
{                                                                         }
{         Generated on: 05.03.2014 21:48:23                               }
{       Generated from: D:\data\work\UniSebest_git\Unicorn\J1201005.xsd   }
{   Settings stored in: D:\data\work\UniSebest_git\Unicorn\J1201005.xdb   }
{                                                                         }
{*************************************************************************}
...
{ IXMLDeclarContent }
  ...
  IXMLDeclarContent = interface(IXMLNode)
    ['{A6849DE9-66C1-41E1-9200-D17D4976CDC5}']
    { Property Accessors }
...
{ IXMLDHead }
  ...
  IXMLDHead = interface(IXMLNode)
    ['{4A3AFD19-91CD-4EEC-8872-65CD481BB949}']
    { Property Accessors }
...
{ IXMLLINKED_DOCS }
  ...
  IXMLLINKED_DOCS = interface(IXMLNodeCollection)
    ['{C93F52BE-401E-4399-B46B-371776C5ADF7}']
    { Property Accessors }
...
{ IXMLDOC }
  ...
  IXMLDOC = interface(IXMLNode)
    ['{CF1E0525-684A-42C8-8A0C-FD1D6C17CDA9}']
    { Property Accessors }
...
{ IXMLDBody }
  ...
  IXMLDBody = interface(IXMLNode)
    ['{268B6B0D-B202-4760-8135-C98AFFA2047B}']
    { Property Accessors }
...
{ IXMLDateColumn }
  ...
  IXMLDateColumn = interface(IXMLNode)
    ['{50F13165-0A87-4CFA-AE7C-DE5A4DBE3C83}']
    { Property Accessors }
...
{ IXMLDateColumnList }
  ...
  IXMLDateColumnList = interface(IXMLNodeCollection)
    ['{FA4CC541-DD8A-4C5B-B63B-83BD8074F6A6}']
    { Methods & Properties }
...
{ IXMLStrColumn }
  ...
  IXMLStrColumn = interface(IXMLNode)
    ['{B79974EA-BFB5-4D6A-9E4B-EEB3CF49F404}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLStrColumnList }
  ...
  IXMLStrColumnList = interface(IXMLNodeCollection)
    ['{EDA79605-9DAA-44F3-8545-CC9CBD887FEB}']
    { Methods & Properties }
...
{ IXMLUKTZEDColumn }
  ...
  IXMLUKTZEDColumn = interface(IXMLNode)
    ['{AEA5A313-446F-42EB-832F-9C6E66447677}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLUKTZEDColumnList }
  ...
  IXMLUKTZEDColumnList = interface(IXMLNodeCollection)
    ['{17BE21DC-30AA-4C0B-A517-8AC24B66E965}']
    { Methods & Properties }
...
{ IXMLDecimal6Column_R }
  ...
  IXMLDecimal6Column_R = interface(IXMLNode)
    ['{16F3078C-CE24-45CB-A63B-79C8F84AFC3D}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDecimal6Column_RList }
  ...
  IXMLDecimal6Column_RList = interface(IXMLNodeCollection)
    ['{AE25FB93-0870-4E73-9752-1BBC48A3C09F}']
    { Methods & Properties }
...
{ IXMLDecimal12Column_R }
  ...
  IXMLDecimal12Column_R = interface(IXMLNode)
    ['{69DDD12E-7720-4CB3-99EC-F5CB825B7B5A}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDecimal12Column_RList }
  ...
  IXMLDecimal12Column_RList = interface(IXMLNodeCollection)
    ['{CC260586-E9EA-4B61-A191-963E0F50CDB2}']
    { Methods & Properties }
...
{ IXMLDecimal2Column }
  ...
  IXMLDecimal2Column = interface(IXMLNode)
    ['{763D3EFF-C2AB-43CD-B423-5F4D15654FD7}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDecimal2ColumnList }
  ...
  IXMLDecimal2ColumnList = interface(IXMLNodeCollection)
    ['{74244EA4-6A80-4A1B-B8A3-04FA1E0B6C0A}']
    { Methods & Properties }
