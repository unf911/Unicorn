...
{                      XML Data Binding                       }
{                                                             }
{         Generated on: 08.04.2011 18:53:39                   }
{       Generated from: D:\data\work\UniSebest\J0215102.xsd   }
{   Settings stored in: D:\data\work\UniSebest\J0215102.xdb   }
{                                                             }
{*************************************************************}
...
{ IXMLDeclarContent }
  ...
  IXMLDeclarContent = interface(IXMLNode)
    ['{0EF69E66-9262-430F-8F26-AF098D8ED86D}']
    { Property Accessors }
...
{ IXMLDHead }
  ...
  IXMLDHead = interface(IXMLNode)
    ['{E864CBB0-8687-4403-87F5-31139C0A5D65}']
    { Property Accessors }
...
{ IXMLLINKED_DOCS }
  ...
  IXMLLINKED_DOCS = interface(IXMLNodeCollection)
    ['{7B4AE987-0AD2-4E87-87CA-6B2D1F28C44F}']
    { Property Accessors }
...
{ IXMLDOC }
  ...
  IXMLDOC = interface(IXMLNode)
    ['{97606DA2-134D-46A7-B33B-707D0A767D5B}']
    { Property Accessors }
...
{ IXMLDBody }
  ...
  IXMLDBody = interface(IXMLNode)
    ['{24EE2DB5-B4BB-428A-9998-75112E375BD9}']
    { Property Accessors }
...
{ IXMLIndTaxNumColumn }
  ...
  IXMLIndTaxNumColumn = interface(IXMLNode)
    ['{C64561FF-180E-479E-8B5A-1231250DBBC0}']
    { Property Accessors }
...
{ IXMLIndTaxNumColumnList }
  ...
  IXMLIndTaxNumColumnList = interface(IXMLNodeCollection)
    ['{E56B5BE9-3F16-4614-A53A-1842A6F25A76}']
    { Methods & Properties }
...
{ IXMLDecimal2Column }
  ...
  IXMLDecimal2Column = interface(IXMLNode)
    ['{D352B91C-E62A-4F0D-ABE9-B093CD1F0D7D}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDecimal2ColumnList }
  ...
  IXMLDecimal2ColumnList = interface(IXMLNodeCollection)
    ['{68353CBA-B92B-4FD4-A8D7-A9CAC47057F0}']
    { Methods & Properties }
...
{ IXMLMonthColumn }
  ...
  IXMLMonthColumn = interface(IXMLNode)
    ['{3FA632AE-5030-43B7-95C2-7A61154E83F8}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLMonthColumnList }
  ...
  IXMLMonthColumnList = interface(IXMLNodeCollection)
    ['{02304F92-5FF4-4AC4-A06E-F507486DFB30}']
    { Methods & Properties }
...
{ IXMLYearColumn }
  ...
  IXMLYearColumn = interface(IXMLNode)
    ['{260ACA0B-8F5F-4C31-9D2D-AE9B98369453}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLYearColumnList }
  ...
  IXMLYearColumnList = interface(IXMLNodeCollection)
    ['{D3401989-E176-4E57-A877-C752F73160F5}']
    { Methods & Properties }
