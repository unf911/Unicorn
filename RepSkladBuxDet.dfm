object frmRepSkladBuxDet: TfrmRepSkladBuxDet
  Left = 213
  Top = 308
  BorderStyle = bsDialog
  Caption = #1044#1077#1090#1072#1083#1080#1079#1072#1094#1080#1103' '#1089#1077#1073#1077#1089#1090#1086#1080#1084#1086#1089#1090#1080' ('#1073#1091#1093')'
  ClientHeight = 333
  ClientWidth = 689
  Color = clBtnFace
  ...
  object sdsSklostdet: TSQLDataSet
    CommandText = 
      ...
      'et_kolotp,'#13#10'  r.kredit_kolotp,'#13#10'  r.attr1 as id_nakld,'#13#10'  om.id_' +
      'izg, '#13#10'  om.id_zak,'#13#10'  om.id_manager,  '#13#10'  om.nds,'#13#10'  om.id,'#13#10'  ' +
      'om.tip,'#13#10'  (select fullname from objects o where o.oid=om.tip) a' +
      's tip_name '#13#10'from rep_oborotka_det_pc(:id_schet,:dat_from,:dat_t' +
      'o,'#13#10'  :sub1_in,:sub2_in,'#13#10'  :sub3_in,:sub4_in,'#13#10'  :sub5_in,null,' +
      #13#10'  null,null,'#13#10'  null,null,'#13#10'  :id_nakl,:attr1,'#13#10'  :attr2) r in' +
      'ner join naklo om'#13#10'    on om.id_nakl=r.id_nakl'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftUnknown
