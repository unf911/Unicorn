object frmSebestOtgr: TfrmSebestOtgr
  Left = 414
  Top = 350
  BorderStyle = bsDialog
  Caption = #1054#1090#1095#1105#1090' '#1087#1086' '#1089#1077#1073#1077#1089#1090#1086#1080#1084#1086#1089#1090#1080' '#1086#1090#1075#1088#1091#1079#1086#1082
  ClientHeight = 404
  ClientWidth = 630
  Color = clBtnFace
  ...
  object sdsRasx: TSQLDataSet
    CommandText = 
      'select '#13#10'from rep_sebest_otgr_pc(:mode,:dat_from,:dat_to,'#13#10':id_i' +
      'zg_in,:id_zak_in,:id_manager_in,:id_sklad_in,:id_tovar_in,null,n' +
      'ull) r'
    MaxBlobSize = -1
    Params = <
      item
