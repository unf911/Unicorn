...
{                      XML Data Binding                       }
{                                                             }
{         Generated on: 21.12.2011 0:34:47                    }
{       Generated from: D:\data\work\UniSebest\J1201004.xsd   }
{   Settings stored in: D:\data\work\UniSebest\J1201004.xdb   }
{                                                             }
{*************************************************************}
...
{ IXMLDeclarContent }
  ...
  IXMLDeclarContent = interface(IXMLNode)
    ['{BBC69518-C365-4AB1-ADBC-0EED823B723E}']
    { Property Accessors }
...
{ IXMLDHead }
  ...
  IXMLDHead = interface(IXMLNode)
    ['{3B37C3B3-B0A5-4F50-8A6A-41A8CDB227BD}']
    { Property Accessors }
...
{ IXMLLINKED_DOCS }
  ...
  IXMLLINKED_DOCS = interface(IXMLNodeCollection)
    ['{48F72BE2-3BA6-4E91-A18A-441E74B711E1}']
    { Property Accessors }
...
{ IXMLDOC }
  ...
  IXMLDOC = interface(IXMLNode)
    ['{14DF69C8-F6CE-4F01-B777-EDC936AD9ECB}']
    { Property Accessors }
...
{ IXMLDBody }
  ...
  IXMLDBody = interface(IXMLNode)
    ['{3B10A878-1EEB-43FB-92C2-7330EE837F93}']
    { Property Accessors }
    ...
    function Get_HNSPDVSEL: Int64;
    function Get_HNSPDVBUY: Int64;
    ...
    function Get_RXXXXG5S: IXMLStrColumnList;
    ...
    function Get_R03G8: WideString;
    function Get_R03G9: WideString;
    ...
    procedure Set_HNSPDVSEL(Value: Int64);
    procedure Set_HNSPDVBUY(Value: Int64);
    ...
    procedure Set_R03G8(Value: WideString);
    procedure Set_R03G9(Value: WideString);
    ...
    property HNSPDVSEL: Int64 read Get_HNSPDVSEL write Set_HNSPDVSEL;
    property HNSPDVBUY: Int64 read Get_HNSPDVBUY write Set_HNSPDVBUY;
    ...
    property RXXXXG5S: IXMLStrColumnList read Get_RXXXXG5S;
    ...
    property R03G8: WideString read Get_R03G8 write Set_R03G8;
    property R03G9: WideString read Get_R03G9 write Set_R03G9;
...
{ IXMLDateColumn }
  ...
  IXMLDateColumn = interface(IXMLNode)
    ['{D34C8AE6-F742-4042-BF6A-BCE25AF47205}']
    { Property Accessors }
...
{ IXMLDateColumnList }
  ...
  IXMLDateColumnList = interface(IXMLNodeCollection)
    ['{7319C231-AD12-4DFC-A0FC-A417D476BE11}']
    { Methods & Properties }
...
{ IXMLStrColumn }
  ...
  IXMLStrColumn = interface(IXMLNode)
    ['{DA3998E4-4022-49D3-98EE-69856DB7189F}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLStrColumnList }
  ...
  IXMLStrColumnList = interface(IXMLNodeCollection)
    ['{CF396CA7-0480-471A-B1AA-35846CD401DE}']
    { Methods & Properties }
...
{ IXMLUKTZEDColumn }
  ...
  IXMLUKTZEDColumn = interface(IXMLNode)
    ['{F4A9050B-D74A-42DF-ADF1-A049991326C1}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLUKTZEDColumnList }
  ...
  IXMLUKTZEDColumnList = interface(IXMLNodeCollection)
    ['{206F6A3A-DFD1-4E49-84C7-3DCCBC7E289C}']
    { Methods & Properties }
...
{ IXMLDecimal6Column_R }
  ...
  IXMLDecimal6Column_R = interface(IXMLNode)
    ['{56481EF0-ADB9-4DF3-8059-CA4B4C5A5D12}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDecimal6Column_RList }
  ...
  IXMLDecimal6Column_RList = interface(IXMLNodeCollection)
    ['{3007ADEE-CB8D-4F63-9E74-1F66A6172441}']
    { Methods & Properties }
...
{ IXMLDecimal12Column_R }
  ...
  IXMLDecimal12Column_R = interface(IXMLNode)
    ['{CFA7DCA1-0B9D-4176-886D-F093A7408024}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDecimal12Column_RList }
  ...
  IXMLDecimal12Column_RList = interface(IXMLNodeCollection)
    ['{81D7A801-6E55-43F1-8B3C-1A12C585D341}']
    { Methods & Properties }
...
{ IXMLDecimal2Column }
  ...
  IXMLDecimal2Column = interface(IXMLNode)
    ['{9866CF49-9306-4A49-99A7-57A86D3973C1}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDecimal2ColumnList }
  ...
  IXMLDecimal2ColumnList = interface(IXMLNodeCollection)
    ['{9ECC8690-D84D-4DD4-8247-F228D86415F4}']
    { Methods & Properties }
...
begin
  ...
  RegisterChildNode('RXXXXG5S', TXMLStrColumn);
  ...
  FRXXXXG5S := CreateCollection(TXMLStrColumnList, IXMLStrColumn, 'RXXXXG5S') as IXMLStrColumnList;
...
function TXMLDBody.Get_HNSPDVSEL: Int64;
begin
  Result := ChildNodes['HNSPDVSEL'].NodeValue;
end;

procedure TXMLDBody.Set_HNSPDVSEL(Value: Int64);
begin
  ChildNodes['HNSPDVSEL'].NodeValue := Value;
end;

function TXMLDBody.Get_HNSPDVBUY: Int64;
begin
  Result := ChildNodes['HNSPDVBUY'].NodeValue;
end;

procedure TXMLDBody.Set_HNSPDVBUY(Value: Int64);
begin
...
function TXMLDBody.Get_RXXXXG5S: IXMLStrColumnList;
begin
  Result := FRXXXXG5S;
end;
...
function TXMLDBody.Get_R03G8: WideString;
begin
  Result := ChildNodes['R03G8'].Text;
end;

procedure TXMLDBody.Set_R03G8(Value: WideString);
begin
  ChildNodes['R03G8'].NodeValue := Value;
end;

function TXMLDBody.Get_R03G9: WideString;
begin
  Result := ChildNodes['R03G9'].Text;
end;

procedure TXMLDBody.Set_R03G9(Value: WideString);
begin
  ChildNodes['R03G9'].NodeValue := Value;
end;
