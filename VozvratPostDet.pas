...
type
  TfrmVozvratPostDet = class(TForm)
...
var
  frmVozvratPostDet: TfrmVozvratPostDet;
...
procedure TfrmVozvratPostDet.actOkExecute(Sender: TObject);
begin
  actApply.Execute;
...
procedure TfrmVozvratPostDet.actCancelExecute(Sender: TObject);
begin
  Close;
end;


procedure TfrmVozvratPostDet.FormClose(Sender: TObject;
...
procedure TfrmVozvratPostDet.actApplyExecute(Sender: TObject);
begin
...
function TfrmVozvratPostDet.ShowDetail(posted:integer=0): integer;
begin
 Result := 0; 
try
	dmdEx.StartWaiting;
...
procedure TfrmVozvratPostDet.FormShow(Sender: TObject);
begin
  lcbTovar.SetFocus;
end;

procedure TfrmVozvratPostDet.lcdParentIdNaklDblClick(Sender: TObject);
begin
  ShowNaklrList;
end;

procedure TfrmVozvratPostDet.lcdParentIdNaklKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TfrmVozvratPostDet.ShowNaklrList;
var
  intTemp : integer;
...
procedure TfrmVozvratPostDet.lcdParentIdNaklEditButtons0Click(Sender: TObject;
  var Handled: Boolean);
begin
  ShowNaklrList;
  Handled := true;
...
procedure TfrmVozvratPostDet.lcbTovarKeyPress(Sender: TObject; var Key: Char);
begin
