...
type
  TfrmStatyadrSprEdit = class(TForm)
    dbeName: TDBEdit;
    Label1: TLabel;
    btnOk: TBitBtn;
    btnCancel: TBitBtn;
...
var
  frmStatyadrSprEdit: TfrmStatyadrSprEdit;

implementation
  uses AtsAssert,untRound;
{$R *.dfm}

procedure TfrmStatyadrSprEdit.actOkExecute(Sender: TObject);
begin
  ModalResult := mrOk;
end;

procedure TfrmStatyadrSprEdit.actCancelExecute(Sender: TObject);
begin
  ModalResult := mrCancel;
end;

procedure TfrmStatyadrSprEdit.FormClose(Sender: TObject;
