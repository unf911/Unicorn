object frmSebestOtgrBuxDet: TfrmSebestOtgrBuxDet
  ...
  object cdsSklostdet: TClientDataSet
    ...
    object cdsSklostdetCENA: TFloatField
      DisplayLabel = #1062#1077#1085#1072', '#1075#1088#1085' '#1073#1077#1079' '#1053#1044#1057
      FieldName = 'CENA'
      DisplayFormat = '0.00'
    end
  ...
  object sdsSklostdet: TSQLDataSet
    CommandText = 
      'select'#13#10'  id_partiya,'#13#10'  id,'#13#10'  dat,'#13#10'  kolotp,'#13#10'  sebest,'#13#10'  ce' +
      'na,'#13#10'  kurs,'#13#10'  nalog_nds,'#13#10'  zatraty,'#13#10'  id_nakl,'#13#10'  id_nakld,'#13 +
      #10'  id_uchet_politics,'#13#10'  tip,'#13#10'  tip_name,'#13#10'  id_sklad,'#13#10'  id_sk' +
      'lad_to'#13#10'from   REP_SEBEST_OTGR_BUX_DET_PC('#13#10'  :mode,:id_schet_in' +
      ','#13#10'  :id_sklad_in,:id_tovar_in,'#13#10'  :id_currency_to,:dat_to,'#13#10'  :' +
      'id_partiya_in,:id_nakld_in) r'#13#10'order by dat'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
