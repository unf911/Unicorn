...
begin
  ...
  for
    select
      ...
      k.ipn,f.nds,f.tip,f.vidopl,ab.value1,
    ...
    into :f1_npp,:f3_id,:f2_dat,:f4_zak,
      :ipn,:nds,:tip,:f24_vidopl,:klient_tip,
      :vsego,:nalog_nds,:tip
...
/*     f24_vidopl = null;*/
     ...
     if ((klient_tip is null) and not(tip=3003)) then begin
       f5_ipn=ipn;
       f6_nds=nds;
       f7_nds=vsego;
...
GRANT SELECT ON ATTRIBUTES TO PROCEDURE REP_TOVAR_KNIGA;
