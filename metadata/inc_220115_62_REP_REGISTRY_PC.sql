...
CREATE OR ALTER PROCEDURE REP_REGISTRY_PC (
    id_registr integer,
    dat_in timestamp,
    sub1_in integer,
    sub2_in integer,
  ...
  if (dat_in is not null) then begin
    for
      ...
      where r.id_registr=:id_registr
        ...
        and (r.sub3 between coalesce(:sub3_in,-9,223,372,036,854,775,808) and coalesce(:sub3_in, 9,223,372,036,854,775,807) or r.sub3 is null)
