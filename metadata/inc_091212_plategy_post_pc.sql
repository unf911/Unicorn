...
begin
  ...
  then begin
    ...
    if (nds>=0) then begin
      ...
      execute procedure oplaty_auto_spend_pc(:id_schet_post,:id_nakl,:dat, :id_izg,:id_zak, null,:id_currency, 1,1);
...
/*Отрицательные платежи, т.е. возвраты*/
  ...
  then begin
    ...
    execute procedure oplaty_auto_spend_pc(:id_schet_dolg,:id_nakl,:dat, :id_zak,:id_izg, null,null, 2,1);
  end
  ...
  then begin
    ...
    execute procedure oplaty_auto_spend_pc(:id_schet_dolg_usl,:id_nakl,:dat,
      :id_zak,:id_izg, null,null,:tip_transh_vovz_pok_usl,1);
  end
  ...
  then begin
    ...
    execute procedure oplaty_auto_spend_pc(:id_schet_post_uslug,:id_nakl,
      :dat, :id_izg,:id_zak, null,:id_currency, :tip_transh,1);
