...
CREATE PROCEDURE NAKLP_SEBEST4_RECOUNT_PC (
    id_nakl integer,
    id_sklad integer,
  ...
  do begin
    ...
    if (:tip in (1,2,103) and (:mode in (1,2))) then begin
      ...
      do begin
        ...
        if ((:tip_depend in (5,30,103,10907)) and (mode=1)) then begin
...
GRANT EXECUTE ON PROCEDURE NAKLOT_SEBEST2_POST_PC TO PROCEDURE NAKLP_SEBEST4_RECOUNT_PC;

GRANT EXECUTE ON PROCEDURE NAKLP_SEBEST4_RECOUNT_PC TO PROCEDURE NAKLOT_SEBEST2_POST_PC;
...
GRANT EXECUTE ON PROCEDURE NAKLP_SEBEST4_RECOUNT_PC TO PROCEDURE PROVODKI_CHECK_SKLAD_SEBEST_PC;
GRANT EXECUTE ON PROCEDURE NAKLP_SEBEST4_RECOUNT_PC TO PROCEDURE SKLAD_SEBEST_MINUS_PC;
