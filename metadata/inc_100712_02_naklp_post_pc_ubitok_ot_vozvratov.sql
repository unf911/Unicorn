    ...
    if ((id_schet is null) or (schet_name='ФИНАНСОВЫЙ РЕЗУЛЬТАТ') ) then begin
      ...
      if (parent_tip=:tip_vozvrat) then begin
        ...
        insert into provodki (id_schet,dat,tip,
          ...
          values(:id_schet_finrez,:dat,:tip_prov,
            Round(:sebest_nakl,2),:id_nakl,
            :id_project,:id_statya_rasx_ot_vozvratov,:id_currency_sebest,:id_izg,:id_zak,:id_manager);
        ...
        insert into provodki (id_schet,dat,tip,
          ...
          values(:id_schet_finrez,:dat,:tip_prov,
            Round(:sebest_nakl,2),:id_nakl,
            :id_project,:id_statya_dox_za_dostavku,:id_currency_sebest,:id_izg,:id_zak,:id_manager);
