...
begin
  ...
  then begin
    ...
    execute procedure naklo_auto_spend_pc(:id_schet_post,:id_nakl,:dat, :id_izg,:id_zak, :id_currency_uah, 1);
  end  /*if –¿—◊®“€ — œŒ—“¿¬Ÿ» ¿Ã»*/
...
GRANT EXECUTE ON PROCEDURE NAKLO_AUTO_SPEND_PC TO PROCEDURE NAKLR_POST_PC;
