...
/*    id_sklad_nakl=:id_sklad_nakl;*/
  ...
  IF ((mode IN (4)) AND (z(id_uchet_politics_to)<>z(id_uchet_politics))) THEN BEGIN
  ...
  IF (mode IN (1,4,5,7,8,9)) THEN BEGIN
    for
      ...
      from naklot_sebest2_insert_pc(
        ...
        :id_nakld, :id_izg, :id_zak, :id_nakl, :id_tovar, :id_schet_sebest, :id_sklad_seb, :tip, null)
