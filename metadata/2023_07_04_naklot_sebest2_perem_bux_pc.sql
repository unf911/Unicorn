...
CREATE OR ALTER PROCEDURE NAKLOT_SEBEST2_PEREM_BUX_PC(
    ID_NAKLD INTEGER,
...
declare variable id_partiya_nakld bigint;
...
begin
  ...
  DO BEGIN
    ...
    IF (id_partiya_nakld IS NULL)  THEN BEGIN
        id_partiya_nakld=:id_nakld-(floor(:id_nakld/10000)*10000);
        id_partiya_nakld=((extractyear(:dat)-2000)*100000000)+(extractmonth(:dat)*1000000)+extractday(:dat)*10000+z(:id_partiya_nakld);
    END ELSE BEGIN
    ...
    select id_partiya, sebest
      from naklot_sebest2_insert_pc(
        ...
        :id_nakld, :id_post, :id_zak, :id_nakl, :id_tovar, :id_schet_sebest,
        :id_sklad_seb_to, :tip, :id_partiya_nakld)
...
DESCRIBE PROCEDURE NAKLOT_SEBEST2_PEREM_BUX_PC
'Используется для создания проводок по бух себест для одной позиции бухгалтерского перемещения';

GRANT SELECT ON NAKLOT TO PROCEDURE NAKLOT_SEBEST2_PEREM_BUX_PC;

GRANT SELECT ON NAKLO TO PROCEDURE NAKLOT_SEBEST2_PEREM_BUX_PC;

GRANT EXECUTE ON PROCEDURE ERROR TO PROCEDURE NAKLOT_SEBEST2_PEREM_BUX_PC;

GRANT EXECUTE ON PROCEDURE SKLAD_SEBEST_SETTINGS_PC TO PROCEDURE NAKLOT_SEBEST2_PEREM_BUX_PC;

GRANT SELECT ON SPR_UCHET_POLITICS_VW TO PROCEDURE NAKLOT_SEBEST2_PEREM_BUX_PC;

GRANT EXECUTE ON PROCEDURE KURS_GET_PC TO PROCEDURE NAKLOT_SEBEST2_PEREM_BUX_PC;

GRANT SELECT ON PROVODKI TO PROCEDURE NAKLOT_SEBEST2_PEREM_BUX_PC;

GRANT EXECUTE ON PROCEDURE NAKLOT_SEBEST2_INSERT_PC TO PROCEDURE NAKLOT_SEBEST2_PEREM_BUX_PC;

GRANT EXECUTE ON PROCEDURE NAKLOT_SEBEST2_PEREM_BUX_PC TO PROCEDURE NAKLP_SEBEST_RECOUNT_PC;
GRANT EXECUTE ON PROCEDURE NAKLOT_SEBEST2_PEREM_BUX_PC TO PROCEDURE NAKL_PEREM_BUX_POST_PC;
GRANT EXECUTE ON PROCEDURE NAKLOT_SEBEST2_PEREM_BUX_PC TO SYSDBA;
