...
{                      XML Data Binding                       }
{                                                             }
{         Generated on: 01.04.2013 19:13:41                   }
{       Generated from: D:\data\work\UniSebest\J1201506.xsd   }
{   Settings stored in: D:\data\work\UniSebest\J1201506.xdb   }
{                                                             }
{*************************************************************}
...
{ IXMLDeclarContent }
  ...
  IXMLDeclarContent = interface(IXMLNode)
    ['{7A90F12A-200A-480F-8533-7CD7D0A5FBBB}']
    { Property Accessors }
...
{ IXMLDHead }
  ...
  IXMLDHead = interface(IXMLNode)
    ['{62CA75A7-8463-4167-8766-FDC00B62C7E9}']
    { Property Accessors }
...
{ IXMLLINKED_DOCS }
  ...
  IXMLLINKED_DOCS = interface(IXMLNodeCollection)
    ['{5A3FFB0C-A756-4EB3-A12F-FD9F2A1FC2F3}']
    { Property Accessors }
...
{ IXMLDOC }
  ...
  IXMLDOC = interface(IXMLNode)
    ['{593DE2B5-9D23-4F4D-8FC3-57EB9613365E}']
    { Property Accessors }
...
{ IXMLDBody }
  ...
  IXMLDBody = interface(IXMLNode)
    ['{05397DAB-CEBA-4BBC-AE2F-D13C443BF98D}']
    { Property Accessors }
...
{ IXMLIntColumn }
  ...
  IXMLIntColumn = interface(IXMLNode)
    ['{781D19F4-6511-413B-88CA-D2665579EFD4}']
    { Property Accessors }
...
{ IXMLIntColumnList }
  ...
  IXMLIntColumnList = interface(IXMLNodeCollection)
    ['{8F5DDF4F-0B70-41B9-9A1C-B7CCE3CF05C6}']
    { Methods & Properties }
...
{ IXMLDateColumn }
  ...
  IXMLDateColumn = interface(IXMLNode)
    ['{AF848652-605C-4111-A867-2EC2890F678C}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDateColumnList }
  ...
  IXMLDateColumnList = interface(IXMLNodeCollection)
    ['{871439F5-95A3-4394-84A5-139C56A4278E}']
    { Methods & Properties }
...
{ IXMLStrColumn }
  ...
  IXMLStrColumn = interface(IXMLNode)
    ['{B2782EE3-4226-48B7-B0B7-44CBC4360FD6}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLStrColumnList }
  ...
  IXMLStrColumnList = interface(IXMLNodeCollection)
    ['{625B7D7C-4C19-4DAF-ACFC-1707CC2CC844}']
    { Methods & Properties }
...
{ IXMLDGKodTypeDoc6_1Column }
  ...
  IXMLDGKodTypeDoc6_1Column = interface(IXMLNode)
    ['{62B96C3F-11B4-40B7-8B16-0EC8C1FBB853}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDGKodTypeDoc6_1ColumnList }
  ...
  IXMLDGKodTypeDoc6_1ColumnList = interface(IXMLNodeCollection)
    ['{9DF8960F-F993-42EC-BC44-7DFAFD2EF358}']
    { Methods & Properties }
...
{ IXMLDGKodausesOperation6Column }
  ...
  IXMLDGKodausesOperation6Column = interface(IXMLNode)
    ['{5245F5C2-5B16-4464-88EE-0AFDC1A4A68B}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDGKodausesOperation6ColumnList }
  ...
  IXMLDGKodausesOperation6ColumnList = interface(IXMLNodeCollection)
    ['{3C96EDD8-E9B1-411E-B426-535BE74E0DC1}']
    { Methods & Properties }
...
{ IXMLDGKodRectification6Column }
  ...
  IXMLDGKodRectification6Column = interface(IXMLNode)
    ['{429175A0-71FB-4161-A616-8E7963C7271E}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDGKodRectification6ColumnList }
  ...
  IXMLDGKodRectification6ColumnList = interface(IXMLNodeCollection)
    ['{2AE3B8D8-A483-4AD7-9F2A-2D8AD8276235}']
    { Methods & Properties }
...
{ IXMLHIPNColumn0 }
  ...
  IXMLHIPNColumn0 = interface(IXMLNode)
    ['{15A03CEC-0467-42DB-B11E-3A1D825D8760}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLHIPNColumn0List }
  ...
  IXMLHIPNColumn0List = interface(IXMLNodeCollection)
    ['{F6F47543-08C3-4D6A-888F-A42FAAC7CA30}']
    { Methods & Properties }
...
{ IXMLDecimal2Column }
  ...
  IXMLDecimal2Column = interface(IXMLNode)
    ['{7A30792A-59A9-47A4-8A59-87EF1B2917D6}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDecimal2ColumnList }
  ...
  IXMLDecimal2ColumnList = interface(IXMLNodeCollection)
    ['{C96CF31F-FDC2-4483-85F1-FFA34BB24186}']
    { Methods & Properties }
...
{ IXMLDGKodDocROVPD6_2Column }
  ...
  IXMLDGKodDocROVPD6_2Column = interface(IXMLNode)
    ['{CF0156AF-94DB-4501-9FC7-40D0E3BABDF2}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDGKodDocROVPD6_2ColumnList }
  ...
  IXMLDGKodDocROVPD6_2ColumnList = interface(IXMLNodeCollection)
    ['{102242A3-EC65-4172-AB61-643C48D1F6CE}']
    { Methods & Properties }
...
{ IXMLDGKodAssignment6Column }
  ...
  IXMLDGKodAssignment6Column = interface(IXMLNode)
    ['{4937DC5B-F523-4CE7-B233-DD3F21415C2D}']
    { Property Accessors }
    function Get_ROWNUM: Integer;
    procedure Set_ROWNUM(Value: Integer);
    { Methods & Properties }
...
{ IXMLDGKodAssignment6ColumnList }
  ...
  IXMLDGKodAssignment6ColumnList = interface(IXMLNodeCollection)
    ['{FC29A4E1-473B-49F7-A3CD-8CF5939ECF1D}']
    { Methods & Properties }
