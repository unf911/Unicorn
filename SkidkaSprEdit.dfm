object frmSkidkaSprEdit: TfrmSkidkaSprEdit
  Left = 276
  Top = 204
  BorderStyle = bsDialog
  Caption = #1056#1077#1076#1072#1082#1090#1080#1088#1086#1074#1072#1085#1080#1077' '#1089#1082#1080#1076#1082#1080
  ClientHeight = 172
  ClientWidth = 322
  Color = clBtnFace
  ...
  object Label3: TLabel
    ...
    Width = 121
    Height = 13
    Caption = '% '#1089#1082#1080#1076#1082#1080' '#1087#1086' '#1091#1084#1086#1083#1095#1072#1085#1080#1102
  end
  ...
  object dbnSkidkaDef: TDBNumberEditEh
    Left = 176
    Top = 36
    Width = 138
    Height = 21
    Anchors = [akLeft, akTop, akRight]
    DataField = 'SKIDKA_DEF'
    DataSource = dsSkladEdit
