...
var
  frmVozvratEdit: TfrmVozvratEdit;
...
procedure TfrmVozvratEdit.actOkExecute(Sender: TObject);
begin
  actApply.Execute;
...
procedure TfrmVozvratEdit.actCancelExecute(Sender: TObject);
begin
  Close;
end;

procedure TfrmVozvratEdit.FormClose(Sender: TObject;
...
procedure TfrmVozvratEdit.actApplyExecute(Sender: TObject);
begin
...
procedure TfrmVozvratEdit.ShowNaklrList;
var
  intTemp : integer;
  strIdTemp : string;
  dFrom,dTo : TDate;
...
procedure TfrmVozvratEdit.lcdParentIdNaklEditButtons0Click(
...
procedure TfrmVozvratEdit.FormShow(Sender: TObject);
begin
  dbeId.SetFocus;
...
procedure TfrmVozvratEdit.lcdParentIdNaklKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TfrmVozvratEdit.lcdParentIdNaklDblClick(Sender: TObject);
begin
  ShowNaklrList;
end;

procedure TfrmVozvratEdit.DBLookupComboboxEh1KeyValueChanged(
  Sender: TObject);
begin
  KursChange;
  //ShowKursGtd;
...
procedure TfrmVozvratEdit.DBLookupComboboxEh2KeyValueChanged(
  Sender: TObject);
begin
  KursChange;
  //ShowKursGtd;
...
procedure TfrmVozvratEdit.dneKursChange(Sender: TObject);
begin
{
...
procedure TfrmVozvratEdit.dneKursIndirectChange(Sender: TObject);
begin
{
  if self.Visible and not semaphore then begin
    if RadioGroup1.ItemIndex=1 then begin
...
procedure TfrmVozvratEdit.RadioGroup1Click(Sender: TObject);
begin
{
...
procedure  TfrmVozvratEdit.KursChange;
begin
 try
  if self.Visible and not semaphore then begin
    dneKurs.Visible:=true;
...
procedure TfrmVozvratEdit.actKursChangeExecute(Sender: TObject);
var
  dKurs : double;
...
procedure TfrmVozvratEdit.dteDatChange(Sender: TObject);
begin
  KursChange;
  //ShowKursGtd;
end;

procedure TfrmVozvratEdit.dspKursGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: String);
begin
  TableName:= 'KURS';
end;

procedure TfrmVozvratEdit.cdsKursAfterInsert(DataSet: TDataSet);
begin
...
procedure TfrmVozvratEdit.cdsKursBeforePost(DataSet: TDataSet);
begin
...
procedure TfrmVozvratEdit.cdsKursKURS_INDIRECTChange(Sender: TField);
var
  iCurTemp : integer;
begin
...
procedure TfrmVozvratEdit.dbeIDKeyPress(Sender: TObject; var Key: Char);
begin
