object frmSkidkaChange: TfrmSkidkaChange
  Left = 2
  Top = 2
  BorderStyle = bsDialog
  Caption = #1048#1079#1084#1077#1085#1077#1085#1080#1103' '#1089#1082#1080#1076#1086#1082
  ClientHeight = 402
  ClientWidth = 630
  Color = clBtnFace
  ...
  object sdsNaklo: TSQLDataSet
    CommandText = 
      ...
      #10'from '#13#10'  SKIDKA_CHANGE_VW n'#13#10'order by'#13#10'  n.dat, n.id_nakl'#13#10
    MaxBlobSize = -1
    Params = <>
  ...
  object cdsNaklo: TClientDataSet
    ...
    object cdsNakloPRICE: TStringField
      DisplayLabel = #1057#1082#1080#1076#1082#1072' '#1087#1086' '#1091#1084#1086#1083#1095#1072#1085#1080#1102
      FieldKind = fkLookup
      FieldName = 'SKIDKA'
  ...
  object sdsPost: TSQLDataSet
    CommandText = 'SKIDKA_CHANGE_POST_PC'
  ...
  object sdsUnpost: TSQLDataSet
    CommandText = 'SKIDKA_CHANGE_UNPOST_PC'
    CommandType = ctStoredProc
    MaxBlobSize = -1
    Params = <
      item
  ...
  object sdsDelmark: TSQLDataSet
    CommandText = 'SKIDKA_CHANGE_DELMARK_PC'
    CommandType = ctStoredProc
    MaxBlobSize = -1
    Params = <
      item
  ...
  object sdsNaklot: TSQLDataSet
    CommandText = 
      ...
      'D_TOVAR,'#13#10'    d.SKIDKA,'#13#10'    d.ID_SEBEST'#13#10'from '#13#10'  SKIDKA_CHANGE' +
      '_DET_VW d '#13#10'  inner join tovar t '#13#10'  on t.oid=d.id_tovar'#13#10'where ' +
      #13#10'  d.id_nakl=:id_nakl'#13#10'order by '#13#10'   upper(t.gruppa1),t.gruppa2' +
      ',t.gruppa3,t.gruppa4'
    MaxBlobSize = -1
    Params = <
      item
