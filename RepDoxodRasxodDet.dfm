object frmRepDoxodRasxodDet: TfrmRepDoxodRasxodDet
  Left = 411
  Top = 137
  BorderStyle = bsDialog
  Caption = #1044#1077#1090#1072#1083#1080#1079#1072#1094#1080#1103' '#1089#1090#1072#1090#1100#1080
  ClientHeight = 333
  ClientWidth = 689
  Color = clBtnFace
  ...
  object cdsSklostdet: TClientDataSet
    ...
    object cdsSklostdetKURS_INDIRECT: TIntegerField
      DisplayLabel = #1054#1073#1088#1072#1090#1085#1099#1081' '#1082#1091#1088#1089
      DisplayWidth = 3
      FieldName = 'KURS_INDIRECT'
    end
    object cdsSklostdetSUM_FINAL: TFloatField
  ...
  object sdsSklostdet: TSQLDataSet
    CommandText = 
      'select'#13#10'  r.dat,'#13#10'  r.id_nakl,'#13#10'  r.debet,'#13#10'  r.kredit,'#13#10'  r.kur' +
      's,'#13#10'  r.kurs_indirect,'#13#10'  z(r.debetincurrency)-z(r.kreditincurre' +
      'ncy) as sum_final,'#13#10'  om.id_izg, '#13#10'  om.id_zak,'#13#10'  om.id_manager' +
      ',  '#13#10'  om.id,'#13#10'  om.tip,'#13#10'  (select fullname from objects o wher' +
      'e o.oid=om.tip) as tipconst'#13#10'from rep_doxod_rasxod_pc(:dat_from,' +
      ':dat_to,:id_currency_to,'#13#10'  :sub1_in,:sub2_in,'#13#10'  :sub3_in,:sub4' +
      '_in) r inner join naklo om'#13#10'    on om.id_nakl=r.id_nakl'#13#10'order b' +
      'y r.dat'
    MaxBlobSize = -1
    Params = <
      item
