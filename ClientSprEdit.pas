...
type
  TfrmClientEdit = class(TForm)
    ...
    dbeOid: TDBEdit;
    DBGridEh1: TDBGridEh;
    sdsContacts: TSQLDataSet;
    dspContacts: TDataSetProvider;
    ...
    sdsContactsOID: TIntegerField;
    sdsContactsNAME: TStringField;
    sdsContactsFULLNAME: TStringField;
    sdsContactsDELMARKED: TSmallintField;
    sdsContactsLASTNAME: TStringField;
    sdsContactsFIRSTNAME: TStringField;
    sdsContactsMIDDLENAME: TStringField;
    sdsContactsBIRTHDAY: TSQLTimeStampField;
    sdsContactsBIRTHPLACE: TStringField;
    sdsContactsID_MARRIAGE: TIntegerField;
    sdsContactsCHILDREN: TStringField;
    sdsContactsHOBBY: TStringField;
    sdsContactsWORKPHONE: TStringField;
    sdsContactsCELLPHONE: TStringField;
    sdsContactsADDPHONE: TStringField;
    sdsContactsEMAIL: TStringField;
    sdsContactsPERSONBYDEF: TSmallintField;
    sdsContactsID_KLIENT: TIntegerField;
    sdsContactsSEX: TSmallintField;
    TabSheet3: TTabSheet;
    DBEdit2: TDBEdit;
    Label5: TLabel;
    DBEdit3: TDBEdit;
    ...
    Label38: TLabel;
    DBEdit31: TDBEdit;
    ToDeletesdsKlient: TSQLDataSet;
    ToDeletedspKlient: TDataSetProvider;
    ToDeletecdsKlient: TClientDataSet;
    dsKlient: TDataSource;
    ToDeletecdsKlientID: TIntegerField;
    ToDeletecdsKlientNAME: TStringField;
    ToDeletecdsKlientRSCH: TStringField;
    ToDeletecdsKlientCODB: TStringField;
    ToDeletecdsKlientNAMEB: TStringField;
    ToDeletecdsKlientOKPO: TStringField;
    ToDeletecdsKlientINDEXI: TFloatField;
    ToDeletecdsKlientOBLAST: TStringField;
    ToDeletecdsKlientTEL: TStringField;
    ToDeletecdsKlientFAX: TStringField;
    ToDeletecdsKlientFORIN: TStringField;
    ToDeletecdsKlientIPN: TStringField;
    ToDeletecdsKlientSVREG: TStringField;
    ToDeletecdsKlientLICO: TStringField;
    ToDeletecdsKlientFIO: TStringField;
    ToDeletecdsKlientOTV: TStringField;
    ToDeletecdsKlientADRES: TStringField;
    ToDeletecdsKlientGOROD: TStringField;
    ToDeletecdsKlientSTAN: TStringField;
    ToDeletecdsKlientADRP: TStringField;
    ToDeletecdsKlientDELMARKED: TSmallintField;
    ToDeletecdsKlientTIP: TIntegerField;
    ToDeletecdsKlientFULLNAME: TStringField;
    ToDeletecdsKlientMODIFIED: TSQLTimeStampField;
    ToDeletecdsKlientDAT_OSNOV: TSQLTimeStampField;
    ToDeletecdsKlientOFFICESKLAD: TStringField;
    ToDeletecdsKlientSOTRUDNIKOV_OT: TIntegerField;
    ToDeletecdsKlientSOTRUDNIKOV_DO: TStringField;
    ToDeletecdsKlientFILIALY: TStringField;
    ToDeletecdsKlientID_ANALOG: TIntegerField;
    ToDeletecdsKlientKTOZAKUPAET: TStringField;
    ToDeletecdsKlientKAKOYKABELNUGEN: TStringField;
    ToDeletecdsKlientOBJEMZAGOD: TStringField;
    ToDeletecdsKlientOBJEMZA6MESYATSEV: TStringField;
    ToDeletecdsKlientKTOMOGETPORUCHITSYA: TStringField;
    ToDeletecdsKlientVASHIPARTNERY: TStringField;
    ToDeletecdsKlientVASHIKONKURENTY: TStringField;
    ToDeletecdsKlientFINANSOVOEPOLOGENIE: TStringField;
    ToDeletecdsKlientDELOVAYAREPUTACIYA: TStringField;
    ToDeletecdsKlientRASPOLAGAETLIKONKURENT: TStringField;
    ToDeletecdsKlientID_SFERADEYATELNOSTI: TIntegerField;
    ToDeletecdsKlientSFERA: TStringField;
    ToDeletecdsKlientANALOG: TStringField;
    TabSheet5: TTabSheet;
    DBGridEh2: TDBGridEh;
    ...
    ToDeletecdsKlientID_MANAGER: TIntegerField;
    ToDeletecdsKlientID_RESULT: TIntegerField;
    ToDeletecdsKlientDAT_CONTACT: TSQLTimeStampField;
    ToDeletecdsKlientRESULT: TStringField;
    ToDeletecdsKlientMANAGER: TStringField;
    TabSheet6: TTabSheet;
    ...
    BitBtn1: TBitBtn;
    actDogovor: TAction;
    sdsContactsID_DOLGNOST: TIntegerField;
    sdsContactsID_MANAGER: TIntegerField;
    ...
    procedure DBGridEh2KeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
//    procedure ToDeletecdsKlientAfterInsert(DataSet: TDataSet);
...
//procedure TfrmClientEdit.ToDeletecdsKlientAfterInsert(DataSet: TDataSet);
//begin
