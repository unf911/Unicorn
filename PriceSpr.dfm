object frmPriceSpr: TfrmPriceSpr
  Left = 94
  Top = 170
  BorderStyle = bsDialog
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' '#1087#1088#1072#1081#1089#1086#1074
  ClientHeight = 237
  ClientWidth = 631
  Color = clBtnFace
  ...
  object sdsSklad: TSQLDataSet
    CommandText = 'select *'#13#10'from SPR_PRICE_VW'#13#10'order by name'
    MaxBlobSize = -1
    Params = <>
  ...
  object cdsSklad: TClientDataSet
    ...
    object cdsSkladID_CURRENCY: TIntegerField
      FieldName = 'ID_CURRENCY'
    end
    object cdsSkladCURRENCY: TStringField
    ...
    object cdsSkladINCLUDE_NDS: TIntegerField
      DisplayLabel = #1062#1077#1085#1099' '#1089' '#1053#1044#1057
      DisplayWidth = 5
      FieldName = 'INCLUDE_NDS'
    end
  end
