object frmRepSkladFact: TfrmRepSkladFact
  Left = 158
  Top = 161
  Width = 587
  Height = 368
  Caption = #1054#1089#1090#1072#1090#1082#1080' '#1080' '#1086#1073#1086#1088#1086#1090#1099' '#1089#1082#1083#1072#1076#1072
  Color = clBtnFace
  ...
  object ActionList1: TActionList
    ...
    object actPartiyaMinus: TAction
      Caption = #1055#1077#1088#1077#1089#1095#1080#1090#1072#1090#1100' '#1086#1090#1088#1080#1094#1072#1090#1077#1083#1100#1085#1099#1077' '#1087#1072#1088#1090#1080#1080
      OnExecute = actPartiyaMinusExecute
    end
  end
  ...
  object sdsRep: TSQLDataSet
    CommandText = 
      ...
      'b2_name,'#13#10'  r.sub1,r.sub2,'#13#10'  sum(r.debetbefore)-minnum(sum(r.de' +
      'betbefore),sum(kreditbefore)) as debetbefore,'#13#10'  sum(r.kreditbef' +
      'ore)-minnum(sum(r.debetbefore),sum(kreditbefore)) as kreditbefor' +
  ...
  object sdsSebestRecountUsual: TSQLDataSet
  ...
  object sdsPartiyaMinus: TSQLDataSet
    CommandText = 
      'select '#13#10'(select name from objects o where o.oid=r.id_tovar) as ' +
      'tovar,'#13#10'(select name from objects o where o.oid=r.id_sklad) as s' +
      'klad,'#13#10'r.*'#13#10'from sklad_sebest_minus_pc(:id_tovar_in,:id_sklad_in' +
      ',null,5) r;'
    MaxBlobSize = -1
    Params = <
      item
