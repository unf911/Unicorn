object frmUslPostavkaSpr: TfrmUslPostavkaSpr
  Left = 340
  Top = 154
  BorderStyle = bsDialog
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' '#1091#1089#1083#1086#1074#1080#1081' '#1087#1086#1089#1090#1072#1074#1082#1080
  ClientHeight = 237
  ClientWidth = 631
  Color = clBtnFace
  ...
  object sdsSklad: TSQLDataSet
    CommandText = 'select *'#13#10'from SPR_USL_POSTAVKA_VW'#13#10'order by name'
    MaxBlobSize = -1
    Params = <>
